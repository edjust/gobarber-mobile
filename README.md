...
To see the **web client**, click here: [GoBarber Web](https://github.com/edjust/gobarber-web)
...
```bash
$ git clone https://github.com/edjust/gobarber-mobile.git && cd gobarber-mobile
```
